...
8. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@EndStringBot](http://t.me/EndStringBot) in Telegram.
...
- You can play tracks or playlists from spotify from Alpha Music bot
...
- If you plan to use Alpha Music Bot with your own customized or modified code.
...
- You can change images which are used in Alpha Music Bot.
- You can generate telegaph links from [@AlphaTelegraphBot](http://t.me/vTelegraphBot) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@EndStringBot](http://t.me/EndStringBot) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@EndStringBot](http://t.me/EndStringBot) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@EndStringBot](http://t.me/EndStringBot) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@EndStringBot](http://t.me/EndStringBot) in Telegram.
